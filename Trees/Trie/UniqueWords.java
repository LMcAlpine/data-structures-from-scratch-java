...
//        addUniqueWordsToOrderedList();
    ...
    public void addUniqueWordsToTrie() {
        ...
        while (book.words.current() != null) {
            if (!myTrie.find(book.words.current())) {
                myTrie.insert(book.words.current());
            }
            book.words.next();
        }
        endTimer();

        System.out.println("Adding unique words to a trie... in " + getDuration() + " milliseconds");
        System.out.println(myTrie.size() + " unique words");
        System.out.println(myTrie.comparisons + " comparisons");
        startTimer();
        myTrie.toString();
        endTimer();
        System.out.println("Traversing the trie in... " + getDuration() + " milliseconds" );
    }
